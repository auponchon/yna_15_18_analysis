...
### Merge data 201, define trips and clean trips.
...
The first table shows the summary of trip characteristics with raw data. The second one shows the summary of trip characteristics with a minimum distance of `r dist.thres`km, a minimum duration of `r thres.min`, gaps of less than `r diff.thres` and a minimum of `r row.thres` number of locations to define a trip.
