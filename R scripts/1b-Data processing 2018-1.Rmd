...
length(which(clean.trips.loc.2018$Difftime>30))/nrow(clean.trips.loc.2018)*100
 ...
 reso <- 20 * 60       #time resolution between 2 points in seconds
...
loc.interpolated.2018 <- subset(loc.interpolated.2018,
                                strftime(loc.interpolated.2018$DateTime, "%H", tz="GMT") %in% duty.off)
