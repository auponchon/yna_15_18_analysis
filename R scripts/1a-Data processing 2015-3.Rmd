---
title: "1a-GPS Data processing 2015 - 3 - 360/30"
...
summary.trips.interp<-ddply(summary.trips.interp2,.(Status),summarize,
                            NbInd=length(unique(summary.trips.interp2$ID)),
...
The table shows the summary of trip characteristics with a minimum distance of `r dist.thres`km, a minimum duration of `r dur.thres`min, gaps of less than `r diff.thres`min and a minimum of `r row.thres` number of locations to define a trip with a time resolution of `r reso/60`min for interpolation.
