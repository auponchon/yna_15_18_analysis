...
coordinates(loc.yna)<-c("Longitude","Latitude")
proj4string(loc.yna) <- CRS("+proj=longlat +ellps=WGS84")
loc.yna<-spTransform(loc.yna, CRS("+proj=utm +zone=45 +ellps=WGS84"))

 KUD<- kernelUD(loc.yna[,2],same4all=T,h=50000,grid=1000)
