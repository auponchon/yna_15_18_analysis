...
loc.yna.2015<-subset(loc.yna.2015,loc.yna.2015$States=="1"| loc.yna.2015$States=="2")
...
loc.fail.2015<-subset(loc.yna.2015,loc.yna.2015$Status=="fail")
loc.suc.2015<-subset(loc.yna.2015,loc.yna.2015$Status=="success")
  
save(loc.fail.2015,"Data/NewlyCreatedData/ForRestLocFail2015.RData")
save(loc.suc.2015,"Data/NewlyCreatedData/ForRestLocSuccess2015.RData")
 
rm(loc.fail.2015,loc.suc.2015)
...
loc.yna.2018<-subset(loc.yna.2018,loc.yna.2018$States=="1"| loc.yna.2018$States=="2")
...
g2<-ggplot(loc.yna.2018, aes(x = bearing,fill=Status)) +
 ...
 # dev.off()
  ...
  loc.fail.2018<-subset(loc.yna.2018,loc.yna.2018$Status=="fail")
loc.suc.2018<-subset(loc.yna.2018,loc.yna.2018$Status=="success")
  
save(loc.fail.2018,"Data/NewlyCreatedData/ForRestLocFail2018.RData")
save(loc.suc.2018,"Data/NewlyCreatedData/ForRestLocSuccess2018.RData")
 
rm(loc.fail.2018,loc.suc.2018)
