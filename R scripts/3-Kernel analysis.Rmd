...
st_write(sf_lines,layer="Line_fail",dsn="Data/NewlyCreatedData/Shapefiles",
...
st_write(sf_lines,layer="Line_success",dsn="Data/NewlyCreatedData/Shapefiles",
driver="ESRI Shapefile", delete_layer = TRUE,update=T)
...
writeOGR(loc.yna.suc.day, dsn="Data/NewlyCreatedData/Shapefiles",
         layer="Locations_success_behav_day", driver="ESRI Shapefile",overwrite_layer=T)
```
...
```{r kernels 2015}
    ...
    KUD.fail <- kernelUD(loc.yna.fail.day[,2],same4all=T,h="href",grid=1000)
