---
title: "1-GPS Data processing 2015 - 1 - 360/10"
...
The table shows the summary of trip characteristics with interpolated data from clean trips with a minimum distance of `r dist.thres`km, a minimum duration of `r dur.thres`, gaps of less than `r diff.thres` and a minimum of `r row.thres` number of locations to define a trip with a time resolution of `r reso` for interpolation.
