...
behav15<-ddply(loc.interpolated,.(ID,Status,TravelNb,States),summarize,
               SumDur=sum(Difftime))

trip15<-ddply(loc.interpolated,.(ID,Status,TravelNb),summarize,
              TotDur=sum(Difftime))
...
behav18<-ddply(loc.interpolated.2018,.(ID,Status,TravelNb,States),summarize,
               SumDur=sum(Difftime))

trip18<-ddply(loc.interpolated.2018,.(ID,Status,TravelNb),summarize,
              TotDur=sum(Difftime))
